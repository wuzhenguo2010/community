...
public class DiscussPostService {
    ...
    @Value("${caffeine.posts.expire-seconde}")
    private int expireSeconds;

    // Caffeine核心接口：Cache，LoadingCache（同步缓存，会阻塞其他线程），AsyncLoadingCache（异步）
    ...
    public int addDiscussPost(DiscussPost post){
        ...
        //处理标签，不希望浏览器将<script>sc</script>处理成请求，而是直接当成字符串就行
        //转义HTML标记
