...
import com.njupt.community.dao.LoginTicketMapper;
import com.njupt.community.dao.UserMapper;
import com.njupt.community.entity.LoginTicket;
...
//        return userMapper.selectById(id);
    ...
    public Map<String, Object> register(User user){
        ...
        userMapper.insertUser(user);//配置中配置了自动生成Id

        //发送激活邮件
        Context context = new Context();
        context.setVariable("email", user.getEmail());
        //设置url http://localhost:8080/community/activation/用户id/激活码
...
//        loginTicketMapper.insertLoginTicket(loginTicket);
        ...
        redisTemplate.opsForValue().set(redisKey, loginTicket); // redis会自动把这个对象序列化为json字符串保存
