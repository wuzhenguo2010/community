package com.njupt.community.event;

import com.alibaba.fastjson.JSONObject;
import com.njupt.community.entity.DiscussPost;
import com.njupt.community.entity.Event;
import com.njupt.community.entity.Message;
import com.njupt.community.service.DiscussPostService;
import com.njupt.community.service.ElasticsearchService;
import com.njupt.community.service.MessageService;
...
public class EventConsumer implements CommunityConstant {
    ...
    public void handleShareMessage(ConsumerRecord record){
        ...
        Future future = taskScheduler.scheduleAtFixedRate(task, 500);//每隔500毫秒去查看一下
    ...
    class UploadTask implements Runnable{
        ...
        public void run() {
            ...
            if(file.exists()){
                ...
                // 制定上传机房
                UploadManager manager = new UploadManager(new Configuration(Zone.zone0()));//z0表示华东
                // 等待图片完全生成
                try {
                    Thread.sleep(1000);
